...
def plot_p02_comparison_panel(
    ...
    obs_display = get_display_array(p02_obs, lons, lats, shapefile_path, display_domain)
    pred_display = get_display_array(p02_pred, lons, lats, shapefile_path, display_domain)
