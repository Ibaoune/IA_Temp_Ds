...
def ensure_metric_dirs(exp_path: str | Path, metric_name: str) -> tuple[Path, Path]:
    """
    Create:
    postproc/results/<experiment>/metrics/<metric_name>/data
    postproc/results/<experiment>/metrics/<metric_name>/plots
    """
    exp_path = Path(exp_path)
    experiment_name = exp_path.name
    postproc_dir = Path(__file__).resolve().parent

    metric_root = postproc_dir / "results" / experiment_name / "metrics" / metric_name
...
def ensure_spatial_metric_dirs(
    ...
    """
    Create:
    postproc/results/<experiment>/metrics/<metric_name>/data/<eval_domain>
    postproc/results/<experiment>/metrics/<metric_name>/plots/<eval_domain>
    """
