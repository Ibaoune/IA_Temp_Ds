...
def plot_wams_comparison_panel(
    ...
    obs_display = get_display_array(wams_obs, lons, lats, shapefile_path, display_domain)
    pred_display = get_display_array(wams_pred, lons, lats, shapefile_path, display_domain)
